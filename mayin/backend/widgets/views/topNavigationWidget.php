         ...
         <ul class="nav navbar-nav navbar-right">
            ...
            <li role="presentation" class="dropdown">
               ...
               <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                  <li>
                     <a> <span class="image"><img src="images/img.jpg" alt="Profile Image" /></span> <span>
                     <span>John Smith</span> <span class="time">3 mins ago</span> </span> <span class="message">
            ...
            <li style="margin: 10px">
               <div class="home-web text-center"><a href="<?= Yii::$app->homeUrl ?>" ><i class="fa fa-home" aria-hidden="true" style="font-size: 25px"></i>Trang chu</a></div>
            </li>
         </ul>
      </nav>
   </div>
