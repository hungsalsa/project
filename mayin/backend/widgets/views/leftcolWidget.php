      ...
      <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
         <div class="menu_section">
            ...
            <ul class="nav side-menu">
               <li>
                  <a href="<?= Yii::$app->homeUrl ?>"><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                  
               </li>
               <li>
                  <a><i class="fa fa-newspaper-o"></i> MANAGER <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     <li><a href="##">Banner</a></li>
                  </ul>
               </li>
               <li>
                  <a><i class="fa fa-database"></i> Trang sản phẩm <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                     <li><a href="<?= Yii::$app->homeUrl.'product/group'; ?>">Nhóm danh mục</a></li>
                     <li><a href="<?= Yii::$app->homeUrl.'product/category'; ?>">Danh mục sản phẩm</a></li>
                     
                     <li><a href="<?= Yii::$app->homeUrl.'product/product'; ?>">Sản phẩm</a>
                     </li>
                     <li><a href="<?= Yii::$app->homeUrl.'product/suppliers'; ?>">Nhà cung cấp</a>
                     </li>
                  </ul>
               </li>
               <li>
               ...
               <li>
                  ...
                  <ul class="nav child_menu">
                      <li><a href="<?= Yii::$app->homeUrl ?>manager/banner">Banner</a></li>
                     <li><a href="fixed_sidebar.html">Fixed Sidebar</a>
                     </li>
                     <li><a href="fixed_footer.html">Fixed Footer</a>
                     </li>
                  </ul>
               </li>
            </ul>
